    ...
    return (
        ...
        >
            ...
            <Box sx={{ position: "relative", zIndex: 10, px: { xs: "", md: '20rem' }, py: '5rem', border: { xs: "", md: '0.2px solid white' }, borderRadius: '20px' }}>
                <Typography variant="h5" sx={{ color: ColorHelper.appColorLight, mb: 2 }} >
                    We Are Selling Quality Products
                </Typography>
                <Typography variant="h4" textTransform="uppercase" sx={{ color: ColorHelper.appColorLight, fontWeight: 'bold' }} >
                    serving the glob
                </Typography>
